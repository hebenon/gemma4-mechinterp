...
\begin{table}[h]
\centering
\caption{Scale comparison: E2B (Layer~8) vs.\ 31B (Layer~22). Both from final experimental design. 31B verbal flatness confirmed by paraphrase validation ($N=10$; Table~\ref{tab:31b-validation}).}
\label{tab:31b}
\begin{tabular}{lrrl}
\toprule
...
PC1 (L22) & $0.724 \pm 0.001$ & $0.734 \pm 0.000$ & 10.011 & $-1.000^\dagger$ \\
\bottomrule
